...
class BusinessCard:
    ...
    def toDynamoFormat(self, isUpdate=False):
        ...
        if isUpdate:
            value = {
                ...
                'telephone_numbers': {'Value': {'L': [{'S': str(tn)} for tn in self.telephone_numbers]},  'Action': 'PUT'},
                'email_addresses': {'Value': {'L': [{'S': str(tn)} for tn in self.email_addresses]},  'Action': 'PUT'},
    ...
    def returnJSONFormat(self, isUpdate=False):


        value =  {
            'user_id': self.user_id,
            'card_id': self.card_id,
            'card_names': self.names,
